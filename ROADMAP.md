...
- **Fulfillment observability slice 1: failure alerting** (codex) — branch
  `codex/fulfillment-alerting`. Implements webhook failure alerts with
  throttling only; audit and reconciliation remain separate follow-up slices.
